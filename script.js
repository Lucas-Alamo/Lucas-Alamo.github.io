...
const TRANSLATIONS = {
  es: {
    ...
    'hero.bio':             'Especialista en aseguramiento de calidad con foco en testing manual, automatización y estrategias de QA. Apasionado por entregar software robusto que supere las expectativas del usuario.',
    'hero.cta':             'Ver proyectos',
    'projects.title':       'Proyectos',
    'projects.subtitle':    'Casos de estudio y trabajos destacados en QA y automatización.',
  ...
  en: {
    ...
    'hero.bio':             'Quality assurance specialist focused on manual testing, automation and QA strategy. Passionate about delivering robust software that exceeds user expectations.',
    'hero.cta':             'View projects',
    'projects.title':       'Projects',
    'projects.subtitle':    'Case studies and featured work in QA and test automation.',
